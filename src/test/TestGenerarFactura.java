...
public class TestGenerarFactura {
	...
	public static void main(String[] args) throws Exception {
		...
		Alta alta2 = new Alta(22, medidor3, fecha6, inspector2, 510, 610, 711); //Lectura de medidor3 (Alta Demanda), Cliente = Silvestre Company
		...
		Alta alta6 = new Alta(26, medidor4 , fecha2, inspector2, 199, 102, 100);
		...
		try {
			Factura factura1;
			factura1 = sistema1.generarFactura(medidor1, 5, 2019);
			System.out.println(factura1);
		

			Factura factura2;
			factura2 = sistema1.generarFactura(medidor2, 4, 2019);
			System.out.println(factura2);
	

			Factura factura3;
			factura3 = sistema1.generarFactura(medidor3, 4, 2019);
