...
public class TestEstadisticaMensual {
	...
	public static void main(String[] args) throws Exception {
		...
		Alta alta2 = new Alta(22, medidor3, fecha3, inspector2, 250, 350, 530);
		Alta alta8 = new Alta(22, medidor3, fecha2, inspector2, 150, 220, 330);
		...
		Alta alta5 = new Alta(25, medidor4 , fecha3, inspector2, 350, 350, 430);
		Alta alta7 = new Alta(25, medidor4 , fecha2, inspector2, 250, 250, 330);
		...
		//Generamos la factura, tres facturas en abril y una en junio. 
		sistema1.generarFactura(medidor3, 4, 2019);

		sistema1.generarFactura(medidor1, 4, 2019);

		sistema1.generarFactura(medidor2, 6, 2019);

		sistema1.generarFactura(medidor4, 4, 2019);
