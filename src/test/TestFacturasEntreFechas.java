...
public class TestFacturasEntreFechas {
	...
	public static void main(String[] args) throws Exception {
		...
		Alta alta2 = new Alta(22, medidor3, fecha3, inspector2, 250, 250, 430);
		...
		sistema1.facturaEntreFechas(fecha7, fecha6); // Emitir reporte de facturas emitidas entre fechas.
