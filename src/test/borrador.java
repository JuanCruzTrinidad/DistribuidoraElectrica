...
public class borrador {
	...
	public static void main(String[] args) throws Exception{
		...
		Medidor medidor3 = new Medidor(cj1,268,"Banfield",false,altaBt,zona1); 
		Medidor medidor4 = new Medidor(cj1,290,"Ezeiza",false,altaBt,zona2);
		...
		Baja Baja4 = new Baja(4, medidor1, fecha5, inspector1, 200);
		Baja Baja5 = new Baja(5, medidor1, fecha4, inspector2, 180);
		Baja Baja6 = new Baja(6, medidor1, fecha3, inspector2, 140);
		Baja Baja7 = new Baja(7, medidor1, fecha2, inspector2, 80);
		Baja Baja8 = new Baja(8, medidor1, fecha1, inspector2, 60);
		...
		Baja Baja12 = new Baja(12, medidor2, fecha7, inspector2, 350);
		Baja Baja13 = new Baja(13, medidor2, fecha6, inspector2, 300);
		Baja Baja14 = new Baja(14, medidor2, fecha5, inspector1, 250);
		Baja Baja15 = new Baja(15, medidor2, fecha4, inspector2, 200);
		Baja Baja16 = new Baja(16, medidor2, fecha3, inspector2, 150);
		Baja Baja17 = new Baja(17, medidor2, fecha2, inspector2, 100);
		Baja Baja18 = new Baja(18, medidor2, fecha1, inspector2, 50);
		Baja Baja19 = new Baja(19, medidor2, fecha10, inspector2, 30);
		Baja Baja20 = new Baja(20, medidor2, fecha12, inspector2, 15);


		Alta alta1 = new Alta(21, medidor3, fecha4, inspector2, 500, 600, 701); //Lectura de medidor3 (Alta Demanda), Cliente = Silvestre Company
		Alta alta2 = new Alta(22, medidor3, fecha3, inspector2, 250, 250, 330);
		Alta alta3 = new Alta(23, medidor3, fecha1, inspector2, 120, 202, 200);

		Alta alta4 = new Alta(24, medidor4 , fecha4, inspector2, 500,600,701);  // Lectura de medidor4 (Alta demanda), Cliente = Silvestre Company
		Alta alta5 = new Alta(25, medidor4 , fecha3, inspector2, 250, 250, 330);
		Alta alta6 = new Alta(26, medidor4 , fecha1, inspector2, 120, 202, 200);
		...
		//System.out.println("\tTotal a pagar: "+sistema1.calcularTotal(factura4.getListaItemFactura(), medidor1) + "\n\n");
			...
			try {
			//sistema1.consumoClienteFecha(cj1, fecha4, fecha1); //Emitir reporte de consumos por cliente entre fechas.
			//sistema1.facturaEntreFechas(fecha7, fecha4); // Emitir reporte de facturas emitidas entre fechas.
			//sistema1.energiaTotalEntreFechas(fecha1, fecha4); //Emitir reporte de energía total entregada entre fechas.
			//sistema1.energiaPorBandaTarifa(fecha1, fecha4); //Emitir consumo total por banda tarifaria, para baja y alta demanda y entre fechas.
			//sistema1.estadisticasFacturacionMes(fecha4);//Emitir estadisticas de facturacion mensuales
			//sistema1.mayorConsumoHorarioPico();
